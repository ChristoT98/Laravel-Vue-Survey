<template>
  ...
  <form class="mt-8 space-y-6" @submit="login">
    <div v-if="errorMessage" class="py-3 px-5 bg-red-600 text-white rounded flex items-center justify-between">
      {{ errorMessage }}
  ...
  <path stroke-linecap="round" stroke-linejoin="round" d="M6 18L18 6M6 6l12 12"/>
    ...
    <div class="flex items-center justify-between">
      <div class="flex items-center">
        <input id="remember-me" name="remember-me" v-model="user.remeber" type="checkbox"
